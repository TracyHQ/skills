// The owner's decision (translated: when a key is missing the skill should tell the user they
// have none, and let them supply one or choose to skip) means a missing key must be a
// CONVERSATION before P3 ever runs, not a bare
