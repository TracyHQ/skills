// Owner's decision (this branch), translated from the original: "this skill will run entirely on
// the local machine; the MCP backend is only for storage now" — collection, detection and analysis
